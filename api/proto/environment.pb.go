...
func (*JoinServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_environment_a502bee9f01f40cd, []int{0}
}
...
func (dst *JoinServer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JoinServer.Merge(dst, src)
}
...
func (*Welcome) Descriptor() ([]byte, []int) {
	return fileDescriptor_environment_a502bee9f01f40cd, []int{1}
}
...
func init() {
	proto.RegisterFile("api/proto/environment.proto", fileDescriptor_environment_a502bee9f01f40cd)
}

var fileDescriptor_environment_a502bee9f01f40cd = []byte{
